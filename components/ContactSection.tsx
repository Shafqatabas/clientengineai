...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setStatus('Thank you! Your message has been sent directly to our team.');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
            ...
            <div className="space-y-3 sm:space-y-4 pt-2 sm:pt-4">
              ...
              <div className="flex items-center space-x-3.5 sm:space-x-4 p-3.5 sm:p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80">
                ...
                <div>
                  ...
                  <a href="https://wa.me/923166025651" target="_blank" rel="noopener noreferrer" className="text-xs sm:text-sm font-semibold text-emerald-400 hover:underline">
                    +92 316 6025651
                  </a>
                </div>
              </div>
          ...
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 shadow-2xl relative">
              ...
              {status && (
                <div className="mb-5 sm:mb-6 p-3.5 sm:p-4 rounded-xl bg-purple-500/10 border border-purple-500/30 text-purple-300 text-[11px] sm:text-xs font-medium">
                  {status}
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-xs transition shadow-lg shadow-purple-600/30 cursor-pointer disabled:opacity-50"
                >
